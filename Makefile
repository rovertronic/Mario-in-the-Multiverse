...
SRC_DIRS += actors src src/boot src/game src/engine src/audio src/menu src/buffers levels bin data assets asm lib sound bin/tc_data
...
$(BUILD_DIR)/levels/%/leveldata.o:      CFLAGS += -Wno-overflow
$(BUILD_DIR)/actors/%:                  CFLAGS += -Wno-overflow

...
enum animIDsHumanoid {
    HUMANOID_ANIM_RUN,
    HUMANOID_ANIM_IDLE,
    HUMANOID_ANIM_DIE,
    HUMANOID_ANIM_HOLD_MARIO,
    HUMANOID_ANIM_AXE_HOLD,
    HUMANOID_ANIM_AXE_WALK,
    HUMANOID_ANIM_RICKY_WHACK,
    HUMANOID_ANIM_TERRY_MASH,
    HUMANOID_ANIM_STAGGER,
    HUMANOID_ANIM_SHIELDBLOCK,
    HUMANOID_ANIM_SHOOT,
    HUMANOID_ANIM_BLOCKUP,
};

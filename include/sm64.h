...
#define ACT_FINAL_CUTTER_SEQUENCE            0x0800022E // (0x039 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_BUBBLE_HAT_ATTACK                 0x0000007C // (0x07C)
...
#define ACT_BUBBLE_HAT_JUMP            0x010208BC

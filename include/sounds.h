...
#define SOUND_MITM_LEVEL_J_HOOH                                   SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x08, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_J_MILTANK                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x09, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_J_GEODUDE                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xFF, SOUND_DISCRETE)

...
#define SOUND_MITM_LEVEL_I_HOODBOOMER_DEATH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x12, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODBOOMER_LAUGH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x13, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_TOAD_HELP                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x14, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODOO_SORCERER_MAGIC                  SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x15, 0xFF, SOUND_DISCRETE)

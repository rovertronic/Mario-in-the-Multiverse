...
#define SOUND_MITM_LEVEL_E_DOOR_OPEN                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x07, 0xE0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_DOOR_CLOSE                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x08, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_ELEVATOR                               SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x09, 0xD7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_ITEM                                   SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xE7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_KEY_NEEDED                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xA0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_TELEPORT                               SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0B, 0xE7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_SWITCH                                 SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0C, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_MISSILE_FIRE                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0D, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_MISSILE_EXPLODE                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0E, 0xB0, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_E_GUN_GUY_ALERT                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0F, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_ALERT2                         SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x10, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_ROAMING                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x11, 0xD0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_DAMAGE                         SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x12, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_DEATH                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x13, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_FIRE                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x14, 0xF0, SOUND_DISCRETE)

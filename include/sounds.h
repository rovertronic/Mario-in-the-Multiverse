...
#define SOUND_MITM_LEVEL_I_HOODLUM_SHOT                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x24, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODLUM_RELOAD                         SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x25, 0xFF, SOUND_DISCRETE)

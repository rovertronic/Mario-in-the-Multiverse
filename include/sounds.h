...
#define SOUND_MITM_LEVEL_G_0_STAR_DOOR                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x07, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_1                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x08, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_2                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x09, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_3                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_4                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0B, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_ARROWS                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0C, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_BLACK_HOLE                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0D, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_CUTTER                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0E, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LASER                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0F, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_SCREAM                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x10, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_TELEPORT                                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x11, 0xFF, SOUND_DISCRETE)

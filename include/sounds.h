...
#define SOUND_GENERAL_EXPLOSION7                 /* 0x30490001 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x49, 0xFF, 0) // unverified, unused
...
#define SOUND_MENU_CAMERA_BUZZ                   /* 0x700E0081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x0E, 0xFF, SOUND_DISCRETE)
...
#define SOUND_MENU_CLICK_FILE_SELECT             /* 0x70110081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x11, 0xFF, SOUND_DISCRETE)
...
#define SOUND_MENU_BOWSER_LAUGH                  /* 0x70188081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x18, 0xFF, SOUND_DISCRETE)
...
#define SOUND_OBJ2_EYEROK_SOUND_LONG             /* 0x925B0081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x5B, 0xF0, SOUND_DISCRETE)//--E
...
#define SOUND_ABILITY_KNIGHT_SLIDE                                SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x0B, 0xFE, 0)
#define SOUND_ABILITY_KNIGHT_EQUIP                                SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x0C, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_ABILITY_E_SHOTGUN                              SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x0D, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_ABILITY_E_SHOTGUN2                             SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x0E, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_ABILITY_E_SHOTGUN3                             SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x0F, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_ABILITY_E_SHOTGUN_RACK                         SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x10, 0xFF, SOUND_DISCRETE)
...
#define SOUND_ABILITY_MULTIVERSE_CRACK                            SOUND_ARG_LOAD(SOUND_BANK_MITM_ABILITY, 0x15, 0xFF, SOUND_DISCRETE)
...
#define SOUND_MITM_LEVEL_E_CACO_ALERT                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x01, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_CACO_ALERT2                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x02, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_CACO_DAMAGE                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x03, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_CACO_DAMAGE2                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x04, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_CACO_DEATH                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x05, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_CACO_DEATH2                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x06, 0xF0, SOUND_DISCRETE)

//**fix v
#define SOUND_MITM_LEVEL_O_WALKER_AGGRO1                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x07, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_AGGRO2                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x08, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_AGGRO3                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x09, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_AGGRO4                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_DIE                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0B, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_HIT                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0C, 0xFE, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_O_WALKER_EAT                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0D, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_G_0_STAR_DOOR                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0E, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_J_HOOH                                   SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0F, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_J_MILTANK                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x10, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_J_GEODUDE                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x11, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_G_MARX_LAUGH_1                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x12, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_2                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x13, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_3                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x14, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LAUGH_4                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x15, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_ARROWS                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x16, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_BLACK_HOLE                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x17, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_CUTTER                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x18, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_LASER                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x19, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_SCREAM                            SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1A, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_G_MARX_TELEPORT                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1B, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_I_HOODBOOMER_DEATH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1C, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODBOOMER_LAUGH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1D, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODBOOMER_HAHA                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1E, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_TOAD_HELP                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1F, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_MAGIC_SHIELD                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x20, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODOO_SORCERER_DEATH                  SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x21, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_PIGPOT_DEATH                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x22, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_GRENADE                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x23, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODMONGER_SHOT                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x24, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODMONGER_RELOAD                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x25, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_MASTER_KAGG_ANGRY                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x26, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_MASTER_KAGG_LAUGH                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x27, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_MASTER_KAGG_STOMP                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x28, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_MASTER_KAGG_DAMAGE                     SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x29, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODMONGER_ALERT                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2A, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODMONGER_DEATH1                      SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2B, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODMONGER_PARRY                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2C, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_E_DOOR_OPEN                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2D, 0xE0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_DOOR_CLOSE                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2E, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_ELEVATOR                               SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x2F, 0xD7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_ITEM                                   SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x30, 0xE7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_KEY_NEEDED                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x30, 0xA0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_TELEPORT                               SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x31, 0xE7, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_SWITCH                                 SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x32, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_MISSILE_FIRE                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x33, 0xC0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_MISSILE_EXPLODE                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x34, 0xB0, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_E_GUN_GUY_ALERT                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x35, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_ALERT2                         SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x36, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_ROAMING                        SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x37, 0xD0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_DAMAGE                         SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x38, 0xF0, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_E_GUN_GUY_DEATH                          SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x39, 0xF0, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_C_BELL                                   SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3A, 0xF0, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_SB_TRAIN                                 SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3B, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_SB_BULLET                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3C, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_SB_BLASTER                               SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3D, 0xFF, SOUND_DISCRETE)

#define SOUND_MITM_LEVEL_BOSS_DEFEAT                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3E, 0xFE, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_SPINNING_BLADE                           SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3F, 0xFE, 0)
#define SOUND_MITM_LEVEL_TLIM_TAXI                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x40, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_TLIM_STARAPP                             SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x41, 0xFF, SOUND_DISCRETE)

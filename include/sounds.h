...
#define SOUND_MITM_LEVEL_I_TOAD_HELP                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1E, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODOO_SORCERER_MAGIC                  SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x1F, 0xFF, SOUND_DISCRETE)

...
#define SOUND_MITM_LEVEL_SB_TRAIN                                 SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3B, 0xFE, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_SB_BULLET                                SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x3C, 0xF0, SOUND_DISCRETE)

...
#define SOUND_MITM_LEVEL_I_HOODBOOMER_DEATH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x08, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_HOODBOOMER_LAUGH                       SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x09, 0xFF, SOUND_DISCRETE)
#define SOUND_MITM_LEVEL_I_TOAD_HELP                              SOUND_ARG_LOAD(SOUND_BANK_MITM_LEVEL, 0x0A, 0xFF, SOUND_DISCRETE)

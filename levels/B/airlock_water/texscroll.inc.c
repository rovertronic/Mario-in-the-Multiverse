...
void scroll_airlock_water_airlock_water_mesh_layer_7_vtx_0() {
	int i = 0;
	int count = 4;
	int width = 128 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(airlock_water_airlock_water_mesh_layer_7_vtx_0);
...
void scroll_gfx_mat_airlock_water_water_2_layer7() {
	Gfx *mat = segmented_to_virtual(mat_airlock_water_water_2_layer7);

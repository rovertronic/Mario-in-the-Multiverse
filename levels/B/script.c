...
const LevelScript level_B_entry[] = {
	...
	AREA(1, B_area_1),
		...
		OBJECT(MODEL_CHECKPOINT_FLAG, 3709, 50, -1351, 0, 0, 0, (2 << 16), bhvCheckpointFlag),
		OBJECT(MODEL_CHECKPOINT_FLAG, 7409, 83, -1390, 0, 0, 0, (3 << 16), bhvCheckpointFlag),
		OBJECT(MODEL_CHECKPOINT_FLAG, 1101, -1222, 2623, 0, 0, 0, (4 << 16), bhvCheckpointFlag),
		OBJECT(MODEL_CHECKPOINT_FLAG, 12183, 83, -1390, 0, 0, 0, (5 << 16), bhvCheckpointFlag),
		...
		OBJECT(MODEL_CRUSHER, 8945, 1203, -1230, 0, 0, 0, (0 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 13343, 831, -1495, 0, 0, 0, (5 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 9535, 826, -813, 0, 0, 0, (6 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 8945, 1203, -396, 0, 0, 0, (0 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 14194, 831, -2346, 0, 0, 0, (8 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 15045, 831, -1495, 0, 0, 0, (7 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 14194, 831, -643, 0, 0, 0, (6 << 24), bhvCrusher),
		OBJECT(MODEL_CRUSHER, 8358, 826, -813, 0, 0, 0, (6 << 24), bhvCrusher),
		...
		OBJECT(MODEL_GATE, 10588, 83, -2202, 0, 0, 0, (2 << 24), bhvGate),
		OBJECT(MODEL_GATE, 11432, 83, -2759, 0, -90, 0, (3 << 24), bhvGate),
		...
		OBJECT(MODEL_NONE, 4690, 83, -1387, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_TURRET_PANEL, 8864, 210, -4741, 0, 90, 0, (2 << 24) | (1 << 16), bhvTurretPanel),
		OBJECT(MODEL_TURRET_PANEL, 14194, 193, -2102, 0, -90, 0, (3 << 24) | (1 << 16), bhvTurretPanel),
		OBJECT(MODEL_TURRET_PLATFORM, 5710, -180, -966, 0, 90, 0, (1 << 24) | (0 << 16), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, 10018, -180, -2203, 0, 135, 0, (2 << 24) | (1 << 16) | (2 << 8), bhvTurretPlatform),
		...
		OBJECT(MODEL_TURRET_PLATFORM, 9407, -180, -3478, 0, -135, 0, (2 << 24) | (0 << 16) | (2 << 8), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, 14194, -180, -1495, 0, -180, 0, (3 << 24) | (0 << 16) | (3 << 8), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, 8321, -180, -3478, 0, -45, 0, (2 << 24) | (0 << 16) | (2 << 8), bhvTurretPlatform),

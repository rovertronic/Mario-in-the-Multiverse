...
const LevelScript level_B_entry[] = {
	...
	AREA(1, B_area_1),
		...
		OBJECT(MODEL_LITTLE_SISTER, 4826, 83, -1390, 0, 0, 0, 0x00000000, bhvLittleSister),
		OBJECT(MODEL_GATE, 2508, 539, -1390, 0, 0, 0, (1 << 16), bhvGate),
		OBJECT(MODEL_ALARM, 2571, 596, -1390, 0, 0, 0, 0x00000000, bhvAlarm),
		OBJECT(MODEL_NONE, 0, 365, -365, 0, 0, 0, (0x01 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 179, 83, -1260, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_TURRET_PLATFORM, 5710, -180, -1814, 0, -135, 0, (1 << 24) | (0 << 16), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, 5710, -180, -966, 0, 135, 0, (1 << 24) | (0 << 16), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, 5621, 83, -1403, 0, -135, 0, (1 << 24) | (2 << 16), bhvTurretPanel),
		...
		OBJECT(MODEL_TURRET_PLATFORM, -5258, -212, -1051, 0, -135, 0, (3 << 24) | (0 << 16) | (3 << 8), bhvTurretPlatform),
		OBJECT(MODEL_TURRET_PLATFORM, -5258, -212, -623, 0, -135, 0, (3 << 24) | (0 << 16) | (3 << 8), bhvTurretPlatform),
		...
		OBJECT(MODEL_TURRET_BODY, -6866, 50, -208, 0, 180, 0, (2 << 24) | (2 << 16), bhvTurretPanel),
		OBJECT(MODEL_TURRET_BODY, -6866, 50, -749, 0, -90, 0, (2 << 24), bhvTurretBody),
		OBJECT(MODEL_TURRET_BODY, -5972, 50, -1176, 0, -90, 0, (3 << 24), bhvTurretBody),
		OBJECT(MODEL_TURRET_BODY, -5972, 50, -208, 0, 180, 0, (3 << 24) | (2 << 16), bhvTurretPanel),
		OBJECT(MODEL_TURRET_BODY, 1969, 831, -1389, -180, 90, 0, 0x00000000, bhvTurretBody),
		OBJECT(MODEL_TURRET_BODY, -5972, 50, -749, 0, -90, 0, (3 << 24), bhvTurretBody),

...
const LevelScript level_B_entry[] = {
	...
	AREA(1, B_area_1),
		...
		OBJECT(MODEL_BLUE_COIN_SWITCH, 1270, -1222, 2969, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPieceSwitch),
		OBJECT(MODEL_STAR_PIECE, 2668, -1222, 1774, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, 4540, -1222, 2940, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, 2695, -1222, 3930, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, 4681, -1222, 5070, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, 3736, -1222, 6953, 0, 0, 0, (2 << 24) | (30 << 16), bhvStarPiece),
		...
		OBJECT(MODEL_NONE, -289, -737, 2672, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_DEBRIS, 2668, -1222, 1774, 0, 116, 0, (0 << 24), bhvDebris),
		OBJECT(MODEL_DEBRIS, 4681, -1222, 5070, 0, -36, 0, (0 << 24), bhvDebris),
		OBJECT(MODEL_DEBRIS, 2695, -1222, 3930, 0, 140, 0, (0 << 24), bhvDebris),
		OBJECT(MODEL_DEBRIS, 3736, -1222, 6953, 0, 34, 0, (0 << 24), bhvDebris),
		OBJECT(MODEL_DEBRIS, 4540, -1222, 2940, 0, 74, 0, (0 << 24), bhvDebris),
		OBJECT(MODEL_NONE, 1453, 164, 1474, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_NONE, -3580, 735, -4788, 0, 0, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_NONE, 3736, -2038, 6953, 0, 0, 0, (2 << 24), bhvStar),

...
const LevelScript level_J_entry[] = {
	...
	AREA(2, J_area_2),
		...
		OBJECT(MODEL_J_SKIPLOOM, 14862, 3793, 2848, 0, 0, 0, 0x00000000, bhvSkiploom),
	...
	AREA(3, J_area_3),
		...
		OBJECT(MODEL_J_MILTANK, -6013, 7815, -8816, 0, 0, 0, 0x00000000, bhvMiltank),
	...
	AREA(5, J_area_5),
		...
		OBJECT(MODEL_NONE, -2, 469, 1915, 0, -180, 0, (5 << 24) | (0x0B << 16), bhvWarp),

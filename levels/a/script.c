...
const LevelScript level_a_entry[] = {
	...
	AREA(6, a_area_6),
		WARP_NODE(0x08, LEVEL_A, 0x04, 0x15, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_ABILITY_SIGN, -365, 200, -1108, 0, 31, 0, (ABILITY_KNIGHT << 16), bhvStaticObject),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -1736, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -2136, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -2536, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -2936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -3336, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -3736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -4136, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, 0, -200, -4536, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -400, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -800, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1200, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1600, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2400, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2800, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3200, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3600, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4400, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4800, -200, -5736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -1736, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -2136, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -2536, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -2936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -3336, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -3736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -4136, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -4536, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -4936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -5336, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -1736, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -2136, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -2536, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -2936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -3336, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -3736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -4136, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -4536, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -4936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4000, -200, -5336, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2000, -200, -6136, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -2536, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -2936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -3336, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -3736, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -4136, 0, 0, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -4536, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -4936, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -6000, -200, -5336, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -5200, -200, -1336, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -5600, -200, -1336, 0, 0, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_NONE, -12, 794, -387, 0, 175, 0, (0x01 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -12, 267, -383, 0, -180, 0, (0x0A << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_PT_METAL_BOX, -6000, -171, -2536, 0, 0, 0, (1 << 16), bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, -4000, -171, -5336, 0, 0, 0, (1 << 16), bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, -2000, -171, -5736, 0, 0, 0, (1 << 16), bhvPtMetalBox),
		OBJECT(MODEL_NONE, 0, 200, 300, 0, 0, 0, (0x08 << 16), bhvWarp),

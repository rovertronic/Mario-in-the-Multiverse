...
const LevelScript level_a_entry[] = {
	...
	AREA(6, a_area_6),
		...
		OBJECT(MODEL_FLIPSWITCH_1, -1246, -200, -6464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1646, -200, -6464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2046, -200, -6464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2446, -200, -6464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2846, -200, -6464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3246, -200, -6464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3646, -200, -6464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -6064, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -5664, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -5264, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -4864, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -4064, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -3664, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -3264, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -2864, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -2064, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4846, -200, -1664, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -846, -200, -4464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1246, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1646, -200, -4464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2046, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2446, -200, -4464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2846, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3246, -200, -4464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3646, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4046, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4446, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -846, -200, -2464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1246, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1646, -200, -2464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2046, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2446, -200, -2464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2846, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3246, -200, -2464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3646, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4046, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4446, -200, -2464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -5246, -200, -4464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -1646, -200, -464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2046, -200, -464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2446, -200, -464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -2846, -200, -464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3246, -200, -464, 0, 90, 0, (5 << 24), bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -3646, -200, -464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4046, -200, -464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -4446, -200, -464, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -446, -200, -1264, 0, 90, 0, 0x00000000, bhvFlipswitch),
		OBJECT(MODEL_FLIPSWITCH_1, -446, -200, -864, 0, 90, 0, 0x00000000, bhvFlipswitch),

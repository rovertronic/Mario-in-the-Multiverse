...
const LevelScript level_a_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_A_UFO_ROBOT, a_ufo_robot_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_A_HAM_ROBOT, a_ham_robot_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_A_LAUNCHED_BOX, a_launched_box_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_A_ROBOT_LAUNCHER, a_robot_launcher_geo), 
	...
	AREA(1, a_area_1),
		...
		OBJECT(MODEL_A_GAS_CLOUD, 492, -14, 4540, 0, 0, 0, 0x00000000, bhvAGasCloud),
	...
	AREA(4, a_area_4),
		...
		WARP_NODE(0x19, LEVEL_A, 0x07, 0x18, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -4782, 252, 10027, 0, 0, 0, (0x22 << 16), bhvAirborneDeathWarp),
	...
	AREA(7, a_area_7),
		...
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_A, 0x04, 0x21, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_A, 0x04, 0x22, WARP_NO_CHECKPOINT),

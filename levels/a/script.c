...
const LevelScript level_a_entry[] = {
	...
	AREA(1, a_area_1),
		...
		OBJECT(MODEL_JELLY, -2524, -153, 516, 0, 0, 0, 0x00000000, bhvJelly),
		OBJECT(MODEL_JELLY, -4162, -198, 900, 0, 0, 0, 0x00000000, bhvJelly),
		OBJECT(MODEL_JELLY, -2761, -103, 1936, 0, 0, 0, 0x00000000, bhvJelly),

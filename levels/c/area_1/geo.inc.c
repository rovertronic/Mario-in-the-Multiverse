...
const GeoLayout c_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, c_dl_1_room_normal_geo),
			GEO_BRANCH(1, c_dl_2_room_obfuscate_geo),
		GEO_CLOSE_NODE(),
...
const GeoLayout c_dl_1_room_normal_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout c_dl_2_room_obfuscate_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 0, -1000, 0, 90, 0, 0, c_dl_level_c_001_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, c_dl_level_c_001_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_ALPHA, c_dl_level_c_001_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, c_dl_level_c_001_mesh_layer_6),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

...
const LevelScript level_c_entry[] = {
	...
	AREA(1, c_area_1),
		...
		OBJECT(MODEL_TARGET_BOX, 1915, 1992, 3966, 0, 0, 0, (1), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, 775, 1568, 5945, 0, 0, 0, (1), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -5775, 695, 147, 0, 0, 0, 0x00000000, bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -10302, 284, -2563, 0, 35, 0, (0), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -10082, 284, -3086, 0, 0, 0, 0x00000000, bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -10421, 284, -2981, 0, 0, 0, (1), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -10084, 284, 821, 0, 26, 0, 0x00000000, bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -4897, 284, -1994, 0, 0, 0, (1), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -1063, 1568, -1055, 0, 0, 0, 0x00000000, bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, 6523, 2948, 8818, 0, 0, 0, 0x00000000, bhvTargetBox),
		...
		OBJECT(MODEL_NONE, -2864, 1094, -6190, 0, 0, 0, (2 << 24), bhvHiddenRedCoinStar),

...
const LevelScript level_c_entry[] = {
	...
	AREA(1, c_area_1),
		...
		OBJECT(MODEL_TARGET_BOX, -9625, 284, -3082, 0, -4, 0, (0), bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -9125, 284, -3348, 0, -39, 0, 0x00000000, bhvTargetBox),
		OBJECT(MODEL_TARGET_BOX, -9454, 284, -3481, 0, -39, 0, (1), bhvTargetBox),

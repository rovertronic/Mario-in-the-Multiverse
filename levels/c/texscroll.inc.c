...
void scroll_c_dl_level_c_mesh_layer_1_vtx_23() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(c_dl_level_c_mesh_layer_1_vtx_23);
...
void scroll_c_dl_level_c_001_mesh_layer_5_vtx_2() {
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(c_dl_level_c_001_mesh_layer_5_vtx_2);
...
void scroll_c_dl_level_c_001_mesh_layer_1_vtx_4() {
	int i = 0;
	int count = 26;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(c_dl_level_c_001_mesh_layer_1_vtx_4);
...
void scroll_c_dl_level_c_001_mesh_layer_1_vtx_23() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(c_dl_level_c_001_mesh_layer_1_vtx_23);

...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -501, 1855, 2841, 0, 0, 0, 0x00000000, bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 292, 1855, 2910, 0, 0, 0, 0x01000000, bhvExclamationBox),

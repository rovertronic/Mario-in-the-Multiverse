...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		OBJECT(MODEL_LEVEL_PIPE, 800, 0, 0, 0, 0, 0, (0 << 16), bhvLevelPipe),
		OBJECT(MODEL_LEVEL_PIPE, 800, 0, 600, 0, 0, 0, (1 << 16), bhvLevelPipe),
		OBJECT(MODEL_LEVEL_PIPE, 800, 0, 1200, 0, 0, 0, (2 << 16), bhvLevelPipe),

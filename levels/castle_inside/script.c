...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		//2 blank objects for testing
												   /*0 is BehParam2*/
		OBJECT(MODEL_ROCKET_BUTTON_OFF, -601, 0, 1572, 0, 94, 0, 0x01000000, bhvRocketButton),
		OBJECT(MODEL_ROCKET_BUTTON_OFF, -601, 0, 1061, 0, 87, 0, 0x01300000, bhvRocketButton),
		OBJECT(MODEL_NONE, -601, 0, 1061, 0, 87, 0, 0x01000000, bhvRocketButtonGroup),

		OBJECT(MODEL_ROCKET_BUTTON_OFF, -601, 500, 1572, 0, 94, 0, 0x02300000, bhvRocketButton),
		OBJECT(MODEL_ROCKET_BUTTON_OFF, -601, 500, 1061, 0, 87, 0, 0x02300000, bhvRocketButton),
		OBJECT(MODEL_NONE, -601, 0, 1061, 0, 87, 0, 0x02010000, bhvRocketButtonGroup),

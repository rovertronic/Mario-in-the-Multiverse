...
DEFINE_COURSE(COURSE_INK_TEST, 0x44444440) 
DEFINE_COURSE(COURSE_X, 0x44444440) 
DEFINE_COURSE(COURSE_G, 0x44444440) 
DEFINE_COURSE(COURSE_B, 0x44444440) 
DEFINE_COURSE(COURSE_A, 0x44444440) 
DEFINE_COURSE(COURSE_F, 0x44444440) 
DEFINE_COURSE(COURSE_E, 0x44444440) 
DEFINE_COURSE(COURSE_I, 0x44444440) 
DEFINE_COURSE(COURSE_J, 0x44444440) 
DEFINE_COURSE(COURSE_M, 0x44444440) 
DEFINE_COURSE(COURSE_O, 0x44444440) 
DEFINE_COURSE(COURSE_D, 0x44444440) 
DEFINE_COURSE(COURSE_N, 0x44444440) 
DEFINE_COURSE(COURSE_H, 0x44444440) 
DEFINE_COURSE(COURSE_BIRTHDAY, 0x44444440) 
DEFINE_COURSE(COURSE_L, 0x44444440) 
DEFINE_COURSE(COURSE_BOWSER_COURSE, 0x44444440) 
DEFINE_COURSE(COURSE_C, 0x44444440) 
DEFINE_COURSE(COURSE_K, 0x44444440) 
DEFINE_COURSE(COURSE_SB, 0x44444440) 
DEFINE_COURSES_END()

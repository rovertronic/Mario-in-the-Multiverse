...
const LevelScript level_f_entry[] = {
	...
	AREA(1, f_area_1),
		...
		OBJECT(MODEL_NONE, -18086, 2899, -8214, 0, 0, 0, 0x00000000, bhvFBlowVent),
		...
		OBJECT(MODEL_NONE, -18759, 868, -6288, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -12831, -100, -5906, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -24218, 812, -7251, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_CURTAINPLATFORM1, -17357, 3246, -7917, 0, 0, 0, (3 << 16), bhvFCurtainPlatform),
		OBJECT(MODEL_NONE, -24261, 2619, -8061, 0, 0, 0, (0 << 16), bhvDreamCatalyst),
		OBJECT(MODEL_LEVEL_PIPE, -23953, 595, -7278, 0, -180, 0, 0x00000000, bhvLevelPipe),
		OBJECT(MODEL_NONE, -11500, 3136, -7111, 0, 0, 0, 0x00000000, bhvStaticObject),
		...
		OBJECT(MODEL_NONE, -23439, 595, -7278, 0, 90, 0, (0x0A << 16), bhvInstantActiveWarp),
		MARIO_POS(0x01, -180, -23439, 595, -7278),
		...
		OBJECT(MODEL_RED_COIN, -14573, 190, -4749, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -12739, 190, -2537, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -15584, 190, -1024, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -16613, 190, -3536, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -20274, 190, -2719, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -21046, 190, -5367, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -24253, 190, -4353, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -21545, 190, -813, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_F_SHOOTER, -18362, 595, -7725, 0, 0, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -12740, 750, -7590, 0, -55, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -13925, 595, -6868, 0, -140, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -14878, 595, -7861, 0, -5, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -16159, 595, -6681, 0, -101, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -19271, 595, -6549, 0, 128, 0, 0x00000000, bhvFshooter),
		...
		OBJECT(MODEL_SNUFIT, -17129, 85, -3105, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -19656, 85, -4104, 0, 71, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -22379, 85, -4785, 0, -25, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -19656, 85, -881, 0, 39, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -14995, 85, -1819, 0, -54, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -13361, 85, -3181, 0, 48, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -17477, 85, -4876, 0, -33, 0, 0x00000000, bhvSnufit),
	...
	AREA(2, f_area_2),
		...
		OBJECT(MODEL_ABILITY_SIGN, -1517, 8, 175, 0, 143, 0, (ABILITY_SHOCK_ROCKET << 16), bhvStaticObject),
		...
		OBJECT(MODEL_NONE, 4583, -563, 407, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 439, 813, 3118, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 423, 813, -2871, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -3651, -428, -12, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 817, 137, -409, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -1150, 2588, -6, 0, 90, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 376, 699, 3972, 0, 0, 0, (1 << 16), bhvDreamCatalyst),
		OBJECT(MODEL_NONE, -2637, 2357, -27, 0, 0, 0, (2 << 16), bhvDreamCatalyst),
		OBJECT(MODEL_NONE, -1170, 2349, -8, 0, 0, 0, (3 << 16), bhvDreamCatalyst),
		OBJECT(MODEL_NONE, 3048, 4324, 317, 0, 0, 0, (4 << 16), bhvDreamCatalyst),
		...
		OBJECT(MODEL_F_KEYPAD, -2259, -109, 1840, 0, -180, 0, (2 << 16), bhvKeypad),
		...
		OBJECT(MODEL_NONE, -1170, 2298, -8, 0, 0, 0, (9 << 16), bhvCollectablePainting),
		...
		OBJECT(MODEL_F_SHOOTER, 362, -358, -2476, 0, 87, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 646, -429, -2995, 0, 53, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 2147, -563, -3407, 0, 53, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 1272, -563, 2537, 0, 87, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 1242, -429, 1146, 0, 92, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 1351, -429, 149, 0, 92, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 1592, -429, -1557, 0, 43, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -736, -288, -371, 0, 71, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -2785, -429, 439, 0, 92, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -1580, -429, 2080, 0, 147, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 728, 137, 1099, 0, 179, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 729, 137, -1111, 0, -8, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -1676, 138, -2359, 0, 109, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -1617, 138, -3334, 0, 57, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -540, 341, -2764, 0, -3, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -118, 138, -3260, 0, -3, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -2471, -429, -1522, 0, -3, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -855, -429, -1566, 0, 53, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -1640, 8, 530, 0, 124, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 129, -429, 1255, 0, -107, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -2878, -429, 1561, 0, 108, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_NONE, 3099, -147, 3096, 0, 0, 0, (2 << 24), bhvHiddenStar),
		OBJECT(MODEL_NONE, 2938, 3376, -57, 0, 0, 0, (3 << 24), bhvUVstar),
		OBJECT(MODEL_NONE, 3363, -436, -17, 0, 0, 0, (4 << 24), bhvFshooterStar),

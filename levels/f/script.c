...
const LevelScript level_f_entry[] = {
	...
	AREA(1, f_area_1),
		...
		WARP_NODE(0x03/*a1 entry*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 15038, 577, -1349, 0, -81, 0, (3 << 16), bhvInstantActiveWarp),
	...
	AREA(2, f_area_2),
		...
		WARP_NODE(0x05/*a2 exit*/, LEVEL_F, 0x01, 0x03, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -5, 0, 813, 0, 0, 0, (5 << 16), bhvWarp),

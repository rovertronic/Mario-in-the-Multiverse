...
const LevelScript level_f_entry[] = {
	...
	AREA(3, f_area_3),
		...
		OBJECT(MODEL_F_SHOOTER, -69, 230, 3301, 0, -131, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 320, 230, 539, 0, -33, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, -1344, 230, 2508, 0, 46, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 98, 230, -2583, 0, 65, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 46, 230, -2311, 0, 87, 0, 0x00000000, bhvFshooter),
		OBJECT(MODEL_F_SHOOTER, 1110, 230, -1601, 0, -65, 0, 0x00000000, bhvFshooter),

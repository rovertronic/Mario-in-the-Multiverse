...
const LevelScript level_i_entry[] = {
	...
	AREA(3, i_area_3),
		...
		WARP_NODE(0x0C/*death from area4*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -5260, 555, -8333, 0, -157, 0, (12 << 16), bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_PIGPOT, 6924, 1805, 5749, 0, 0, 0, 0x00000000, bhvPigpot),
		OBJECT(MODEL_PIGPOT, 6803, 1807, 6152, 0, 0, 0, 0x00000000, bhvPigpot),
		...
		OBJECT(MODEL_PLUM, -5537, -133, 5010, 0, 0, 0, 0x00000000, bhvPlum),
	...
	AREA(5, i_area_5),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_MASTER_KAAG, 3, -524, 8, 0, 0, 0, 0x00000000, bhvMasterKaag),
		OBJECT(MODEL_NONE, -584, -524, 4595, 0, 0, 0, (10 << 16), bhvInstantActiveWarp),

...
const LevelScript level_i_entry[] = {
	...
	AREA(3, i_area_3),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BARRIER_ROPE, -2144, 888, -2441, 0, 90, 0, (240 << 8), bhvBarrierAttachedToRope),
		OBJECT(MODEL_PIGPOT, 691, 961, -2827, 0, -60, 0, 0x00000000, bhvPigpot),
		OBJECT(MODEL_PIGPOT, 400, 961, -3161, 0, -14, 0, 0x00000000, bhvPigpot),
		OBJECT(MODEL_PLANK_ROPE, -2066, 1184, 2383, 0, 90, 0, (240 << 8), bhvPlankAttachedToRope),
		OBJECT(MODEL_PLANK_ROPE, 127, 1756, -917, 0, 90, 0, (240 << 8), bhvPlankAttachedToRope),

...
const LevelScript level_i_entry[] = {
	...
	AREA(1, i_area_1),
		...
		OBJECT(MODEL_GATE, -3282, -202, 3297, 0, -25, 0, (1 << 24) | (2 << 16) | (10 << 8) | (50), bhvGrillOpenableByRocketButton),
	...
	AREA(2, i_area_2),
		...
		OBJECT(MODEL_NONE, 2486, 2203, -2154, -90, -90, 0, (1 << 24) | (60 << 16), bhvRocketButton),

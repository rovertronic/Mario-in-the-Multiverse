...
const LevelScript level_i_entry[] = {
	...
	AREA(3, i_area_3),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_PIGPOT, 691, 961, -2827, 0, 0, 0, 0x00000000, bhvPigpot),
		OBJECT(MODEL_PIGPOT, 400, 961, -3161, 0, 0, 0, 0x00000000, bhvPigpot),
		OBJECT(MODEL_PLUM, -2895, 388, 3634, 0, 0, 0, 0x00000000, bhvPlum),
		OBJECT(MODEL_NONE, -3953, 963, -2314, 0, 0, 0, (4 << 24), bhvPlumBucket),
		OBJECT(MODEL_NONE, -2112, 691, 4356, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),

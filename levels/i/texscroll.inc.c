...
void scroll_i_dl_first_section_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 192;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_first_section_mesh_layer_5_vtx_1);
...
void scroll_i_dl_second_section_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 460;
	int height = 128 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_second_section_mesh_layer_1_vtx_0);
...
void scroll_i_dl_second_section_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 12;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_second_section_mesh_layer_5_vtx_1);
...
void scroll_i_dl_second_section_mesh_layer_5_vtx_3() {
	int i = 0;
	int count = 12;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_second_section_mesh_layer_5_vtx_3);
...
void scroll_i_dl_second_section_mesh_layer_5_vtx_4() {
	int i = 0;
	int count = 12;
	int width = 128 * 0x20;
	...
	float offsetX = 0.0;
	Vtx *vertices = segmented_to_virtual(i_dl_second_section_mesh_layer_5_vtx_4);
...
void scroll_i() {
	...
	scroll_i_dl_first_section_mesh_layer_5_vtx_1();
	scroll_i_dl_second_section_mesh_layer_1_vtx_0();
	scroll_i_dl_second_section_mesh_layer_5_vtx_1();
	scroll_i_dl_second_section_mesh_layer_5_vtx_3();
	scroll_i_dl_second_section_mesh_layer_5_vtx_4();
};

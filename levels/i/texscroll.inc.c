...
void scroll_i_dl_main_section_mesh_layer_5_vtx_2() {
	int i = 0;
	int count = 52;
	int width = 64 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(i_dl_main_section_mesh_layer_5_vtx_2);
...
void scroll_i_dl_first_section_geo_mesh_layer_5_vtx_2() {
	int i = 0;
	int count = 12;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_first_section_geo_mesh_layer_5_vtx_2);
...
void scroll_i_dl_first_section_geo_mesh_layer_5_vtx_4() {
	int i = 0;
	int count = 12;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_first_section_geo_mesh_layer_5_vtx_4);
...
void scroll_i_dl_first_section_geo_mesh_layer_5_vtx_6() {
	int i = 0;
	int count = 276;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_first_section_geo_mesh_layer_5_vtx_6);
...
void scroll_i_dl_first_section_geo_mesh_layer_5_vtx_8() {
	int i = 0;
	int count = 230;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(i_dl_first_section_geo_mesh_layer_5_vtx_8);
...
void scroll_i() {
	...
	scroll_i_dl_main_section_mesh_layer_5_vtx_2();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_1();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_2();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_4();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_5();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_6();
	scroll_i_dl_first_section_geo_mesh_layer_5_vtx_8();

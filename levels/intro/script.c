...
const LevelScript level_intro_splash_screen[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_INTRO_SKYBOX, intro_skybox_geo),
    AREA(/*index*/ 1, intro_geo_splash_screen),
        OBJECT(/*model*/ MODEL_INTRO_SKYBOX, /*pos*/ 0,0,0, /*angle*/ 0,  0, 0, /*behParam*/ BP(0x18, 0x00, 0x10, 0x0B), /*beh*/ bhvIntroSkybox),
    END_AREA(),
    FREE_LEVEL_POOL(),

...
const LevelScript level_k_entry[] = {
	...
	AREA(1, k_area_1),
		...
		OBJECT(MODEL_NONE, -7830, -1251, 10010, 0, 0, 0, (11 << 16), bhvDeathWarp),
	...
	AREA(3, k_area_3),
		...
		OBJECT(MODEL_K_SKINNY_RICKY, -338, 1617, -1699, 0, 0, 0, 0x00000000, bhvSkinnyRicky),
	...
	AREA(4, k_area_4),
		...
		OBJECT(MODEL_K_STRONG_TERRY, 1728, -3324, -1270, 0, 139, 0, (3 << 24), bhvKbillionare),

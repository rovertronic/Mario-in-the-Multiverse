...
const LevelScript level_k_entry[] = {
	...
	AREA(1, k_area_1),
		...
		WARP_NODE(3, LEVEL_K, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_LEVEL_PIPE, 576, -2348, 1752, 0, 0, 0, 0x00000000, bhvLevelPipe),
		...
		OBJECT(MODEL_NONE, 1432, -2194, 1715, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
	...
	AREA(2, k_area_2),
		...
		WARP_NODE(/*death*/ 0xF1, LEVEL_K, /*this area*/ 0x01, 0x01, WARP_NO_CHECKPOINT),
		WARP_NODE(/*death entry*/ 0x01, LEVEL_SSL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(1, LEVEL_K, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_ABILITY, 6025, -9645, -6492, 0, 0, 0, (ABILITY_CHRONOS << 16), bhvAbilityUnlock),
		OBJECT(MODEL_NONE, 4146, -6632, 3093, 0, 0, 0, (1 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 1522, -10005, -12047, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
	...
	AREA(3, k_area_3),
		...
		WARP_NODE(/*death*/ 0xF1, LEVEL_K, /*this area*/ 0x01, 0x01, WARP_NO_CHECKPOINT),
		WARP_NODE(/*death entry*/ 0x01, LEVEL_SSL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 306, -1018, -7740, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 182, -557, -2237, 0, 0, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_NONE, 5769, -847, -1222, 0, 0, 0, (6 << 24), bhvStar),
		OBJECT(MODEL_GOOMBA, 5520, -1328, -1222, 0, 0, 0, 0x00000000, bhvGoomba),

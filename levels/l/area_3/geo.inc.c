...
const GeoLayout l_area_3[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, -20078, -9675, 60, -20078, -9775, 60, geo_camera_main),
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, l_area_3_geo),
					GEO_RENDER_OBJ(),

...
const GeoLayout l_area_6_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, l_dl_antimatter_mesh_layer_1),
...
const GeoLayout l_area_6[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 0, 0, -8289, 0, -100, -8289, geo_camera_main),
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, l_area_6_geo),
					GEO_RENDER_OBJ(),

...
const LevelScript level_l_entry[] = {
	...
	AREA(2, l_area_2),
		...
		OBJECT(MODEL_HEART, 9309, 216, 0, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
	...
	AREA(3, l_area_3),
		...
		OBJECT(MODEL_HEART, 11540, -350, 0, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 11540, 1150, 0, 0, 0, 0, 0x00000000, bhvRecoveryHeart),

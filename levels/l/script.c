...
const LevelScript level_l_entry[] = {
	...
	AREA(2, l_area_2),
		...
		OBJECT(MODEL_L_JOHNBLOCK, 4509, 166, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
		OBJECT(MODEL_L_JOHNBLOCK, 4609, 266, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
		OBJECT(MODEL_L_JOHNBLOCK, 4709, 366, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
		OBJECT(MODEL_L_JOHNBLOCK, 4809, 466, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
		OBJECT(MODEL_L_JOHNBLOCK, 4909, 566, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
		OBJECT(MODEL_L_JOHNBLOCK, 5009, 666, 0, 0, 0, 0, (1 << 16), bhvJohnBlock),
	...
	AREA(6, l_area_6),
		...
		OBJECT(MODEL_NONE, -1356, 0, 0, 0, 0, 0, (3 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 1356, 0, 0, 0, 0, 0, (4 << 16), bhvWarp),

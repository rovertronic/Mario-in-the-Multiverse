...
const LevelScript level_l_entry[] = {
	...
	AREA(3, l_area_3),
		...
		OBJECT(MODEL_BLUE_COIN_SWITCH, 2000, 250, 0, 0, 0, 0, (2 << 24) | (45 << 16), bhvStarPieceSwitch),
	...
	AREA(4, l_area_4),
		...
		OBJECT(MODEL_STAR, 3050, 3200, 0, 0, 0, 0, (3 << 24), bhvStar),
	...
	AREA(5, l_area_5),
		WARP_NODE(2, LEVEL_L, 0x04, 8, WARP_NO_CHECKPOINT),
		WARP_NODE(3, LEVEL_L, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -7950, 350, 21, 0, -180, 0, (3 << 16), bhvLDoor),
		OBJECT(MODEL_NONE, -17350, -550, 21, 0, -180, 0, (2 << 16), bhvLDoor),

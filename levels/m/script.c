...
const LevelScript level_m_entry[] = {
	...
	AREA(1, m_area_1),
		...
		INSTANT_WARP(0x00, 0x02, -17900, 0, -4000),
		INSTANT_WARP(0x01, 0x03, -9900, 5000, 0),
		OBJECT(MODEL_NONE, -4600, 2600, 7500, 0, 0, 0, 0x00F00000, bhvDeathWarp),
		...
		OBJECT(MODEL_NONE, -4637, 2600, 7960, 0, -180, 0, (0x0A << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_LEVEL_PIPE, -4600, 2600, 8500, 0, 0, 0, 0x00000000, bhvLevelPipe),
		OBJECT(MODEL_NONE, -4600, 5400, 6000, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_NONE, -7300, 2400, -12900, 0, 0, 0, (7 << 24), bhvStar),
	...
	AREA(2, m_area_2),
		...
		INSTANT_WARP(0x00, 0x01, 17900, 0, 4000),
		...
		OBJECT(MODEL_PT_METAL_BOX, -200, 0, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 0, 0, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 200, 0, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, -200, 200, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 0, 200, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 200, 200, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, -200, 400, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 0, 400, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_PT_METAL_BOX, 200, 400, 5484, 0, 0, 0, 0x00000000, bhvPtMetalBox),
	...
	AREA(3, m_area_3),
		...
		OBJECT(MODEL_RED_COIN, -11800, -5600, 6200, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -11600, -5600, 6200, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -11600, -5600, 6400, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -11800, -5600, 6400, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -5100, -5500, 6100, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -5100, -5500, 6500, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -4500, -5300, 6300, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -4500, -5300, 5900, 0, 0, 0, 0x00040000, bhvFlamethrower),
		OBJECT(MODEL_RED_COIN, -4500, -5300, 6700, 0, 0, 0, 0x00040000, bhvFlamethrower),
		...
		OBJECT(MODEL_NONE, -3000, 1000, 7400, 0, 0, 0, (5 << 24), bhvHiddenRedCoinStar),

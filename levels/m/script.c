...
const LevelScript level_m_entry[] = {
	...
	AREA(2, m_area_2),
		...
		OBJECT(MODEL_NONE, 0, 1700, -4400, 0, -180, 0, 0x00F00000, bhvDeathWarp),
		OBJECT(MODEL_NONE, 0, 1900, -4400, 0, -180, 0, 0x00200000, bhvInstantActiveWarp),
		...
		OBJECT(MODEL_PT_METAL_BOX, 200, 800, 5400, 0, 0, 0, 0x00000000, bhvPtMetalBox),
		OBJECT(MODEL_NONE, 0, 500, 12500, 0, 0, 0, (1 << 24), bhvStar),

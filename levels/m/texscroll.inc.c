...
void scroll_m_dl_A4_Maze_C_001_mesh_layer_4_vtx_1() {
	int i = 0;
	int count = 96;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(m_dl_A4_Maze_C_001_mesh_layer_4_vtx_1);
...
void scroll_m_dl_A4_Room_C_mesh_layer_4_vtx_1() {
	int i = 0;
	int count = 184;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(m_dl_A4_Room_C_mesh_layer_4_vtx_1);

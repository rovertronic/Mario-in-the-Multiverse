...
const GeoLayout o_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, o_dl_viscol_mesh_layer_5),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 250, -2494, 10, o_dl_visual_mesh_layer_5),
		GEO_OPEN_NODE(),
...
const GeoLayout o_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, o_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, o_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_ALPHA, o_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, o_dl_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, o_dl_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};

...
const LevelScript level_o_entry[] = {
	...
	AREA(1, o_area_1),
		...
		OBJECT(MODEL_ABILITY, -858, 37, 907, 0, 0, 0, (ABILITY_DEFAULT << 16), bhvAbilityUnlock),
		OBJECT(MODEL_ABILITY_SIGN, -20249, -10, 924, 0, 45, 0, (ABILITY_MARBLE << 16), bhvStaticObject),
		OBJECT(MODEL_ABILITY_SIGN, -13089, -10, -4346, 0, 45, 0, (ABILITY_ESTEEMED_MORTAL << 16), bhvStaticObject),
		OBJECT(MODEL_ABILITY_SIGN, -1666, -10, -5360, 0, -123, 0, (ABILITY_GADGET_WATCH << 16), bhvStaticObject),
		...
		OBJECT(MODEL_NONE, -13552, 740, -9698, 0, 128, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -11692, 740, -2731, 0, 176, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 1088, 123, 1104, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_NONE, 789, 123, 1104, 0, 0, 0, (2 << 24), bhvStar),
		OBJECT(MODEL_NONE, 250, 264, 10, 0, 0, 0, (3 << 24), bhvHiddenStar),
		OBJECT(MODEL_NONE, 489, 123, 1104, 0, 0, 0, (4 << 24), bhvStar),
		OBJECT(MODEL_NONE, 340, 123, 1104, 0, 0, 0, (5 << 24), bhvStar),
		OBJECT(MODEL_NONE, 190, 123, 1104, 0, 0, 0, (6 << 24), bhvStar),
		OBJECT(MODEL_NONE, 40, 123, 1104, 0, 0, 0, (7 << 24), bhvStar),
		OBJECT(MODEL_STAR_PIECE, -13889, 790, -6614, 0, 0, 0, 0x00000000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -11988, 790, -6614, 0, 0, 0, 0x00000000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -11988, 790, -8497, 0, 0, 0, 0x00000000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -11988, 790, -4746, 0, 0, 0, 0x00000000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -13889, 790, -2858, 0, 0, 0, 0x00000000, bhvStarPiece),
		OBJECT(MODEL_BLUE_COIN_SWITCH, -13889, 790, -4746, 0, 0, 0, (1 << 24) | (100 << 16), bhvStarPieceSwitch),
		...
		OBJECT(MODEL_O_TREE, -17937, 37, 19691, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -16708, 276, 18146, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -15280, 425, 18812, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -13033, 264, 19114, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -11448, 123, 19493, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -11258, -10, 16886, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -13095, 266, 17622, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -10808, -10, 12469, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -9506, -10, 10836, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -1479, 1129, -20991, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -4502, 1129, -20570, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -2110, 1129, -18535, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -8937, 470, -19124, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_TREE, -3776, -10, 4177, 0, 0, 0, 0x00000000, bhvOTree),
		OBJECT(MODEL_O_UVSTAR, -3819, 5100, 2336, 0, 0, 0, 0x00000000, bhvOuvstar),
		OBJECT(MODEL_O_UVSTAR, 250, 1900, 10, 0, 0, 0, 0x00000000, bhvOuvstar),
		OBJECT(MODEL_O_UVSTAR, -4407, 1345, -2911, 0, 0, 0, 0x00000000, bhvOuvstar),
		OBJECT(MODEL_O_UVSTAR, 5308, 1500, 73, 0, 0, 0, 0x00000000, bhvOuvstar),
		OBJECT(MODEL_O_UVSTAR, 988, 945, 5068, 0, 0, 0, 0x00000000, bhvOuvstar),
		...
		OBJECT(MODEL_NONE, -12866, -10, -3376, 0, 0, 0, 0x00000000, bhvOZombieSpawner),
		OBJECT(MODEL_NONE, -13061, -10, -7606, 0, 0, 0, 0x00000000, bhvOZombieSpawner),
		OBJECT(MODEL_NONE, -3219, 3100, 3336, 0, 0, 0, 0x00000000, bhvOZombieSpawner),
		OBJECT(MODEL_NONE, -4219, 4700, 2736, 0, 0, 0, 0x00000000, bhvOZombieSpawner),
		OBJECT(MODEL_NONE, -2219, 3100, 3536, 0, 0, 0, 0x00000000, bhvOZombieSpawner),

...
const LevelScript level_o_entry[] = {
	...
	AREA(1, o_area_1),
		...
		OBJECT(MODEL_O_ZOMBIE_1, 3697, 50, -1188, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3780, 50, -885, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3780, 50, -614, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4040, 50, -749, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3956, 50, -1233, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4353, 50, -998, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4353, 50, -518, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3915, 50, -1188, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3998, 50, -885, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 3998, 50, -614, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4258, 50, -749, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4175, 50, -1233, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4572, 50, -998, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4572, 50, -518, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4166, 50, -1188, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4249, 50, -885, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4249, 50, -614, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4508, 50, -749, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4425, 50, -1233, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4822, 50, -998, 0, 0, 0, 0x00000000, bhvOZombie),
		OBJECT(MODEL_O_ZOMBIE_1, 4822, 50, -518, 0, 0, 0, 0x00000000, bhvOZombie),

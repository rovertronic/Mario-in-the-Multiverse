...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_E__MARIO,                e__mario_geo),
    LOAD_MODEL_FROM_GEO(MODEL_E__ROCKET_BLAST,         e_rocket_blast_geo),
    LOAD_MODEL_FROM_GEO(MODEL_E__MUZZLE_FLASH,         e_muzzle_flash_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_FLIPSWITCH_1,            flipswitch1_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FLIPSWITCH_2,            flipswitch2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FLIPSWITCH_3,            flipswitch3_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_HUMANOID,                humanoid_geo),
    FREE_LEVEL_POOL(),
    POP_POOL(),

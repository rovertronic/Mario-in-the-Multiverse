...
#include "levels/x/header.h"

/* Fast64 begin persistent block [scripts] */
/* Fast64 end persistent block [scripts] */

const LevelScript level_x_entry[] = {
	INIT_LEVEL(),
	LOAD_YAY0(0x7, _x_segment_7SegmentRomStart, _x_segment_7SegmentRomEnd), 
	ALLOC_LEVEL_POOL(),
	...
	AREA(1, x_area_1),
		...
		OBJECT(MODEL_GOOMBA, -1361, 50, -1412, 0, 0, 0, (0 << 16), bhvGoomba),
		...
		TERRAIN(x_area_1_collision),
		MACRO_OBJECTS(x_area_1_macro_objs),
		STOP_MUSIC(0),

...
const char *credits03[] = { "2PIRANHA PIT", "DRAHNOKKS", "WOISSIL" };
const char *credits04[] = { "1MUSHROOM HAVOC","DRAHNOKKS" };
const char *credits05[] = { "1OPPORTUNITY","JOOPII"};
const char *credits06[] = { "1BIOSHOCK RAPTURE","FURYIOUSFIGHT"};
const char *credits07[] = { "1BEYOND THE CURSED PIZZA","LUIGIMAN O64O"};
const char *credits08[] = { "2MARIO NEW MECCA","AXOLLYON","KEYBLADER"};
...
const char *credits15[] = { "1ENVIRONMENTAL STATION M", "MEL" };
...
s32 init_level(void) {
    ...
    switch(gCurrLevelNum) {
        ...
        case LEVEL_SB:
            ...
            break;            
        case LEVEL_MC:
            hub_level_current_index = HUBLEVEL_MC;
            break;
        case LEVEL_BB:
            hub_level_current_index = HUBLEVEL_BB;
            break;
    }
